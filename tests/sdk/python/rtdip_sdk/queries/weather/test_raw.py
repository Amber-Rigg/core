...
from src.sdk.python.rtdip_sdk.queries.weather.latest import get_grid as raw_grid
from src.sdk.python.rtdip_sdk.queries.weather.latest import get_point as raw_point
